...
var Readmore = function (_Component) {
  ...
  _createClass(Readmore, [{
    ...
    value: function resize() {
      ...
      var mh = maxHeight ? maxHeight : getBrowserHeight();
      var elementHeight = this.refs['read_more_' + id].offsetHeight;
      if (elementHeight > mh + offset) this.setState({ displayButton: true });else this.setState({ displayButton: false, hide: true });
    }
  }]);
